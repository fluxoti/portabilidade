...
return array(
    ...
    */
	...
	"weak_password"	   => "A senha deve conter no mínimo 8 caracteres, letras maiúsculas, minúsculas e números.",
	"credentials"	   => "O e-mail ou senha estão incorretos.",
    "active"            => "O usuário não autorizado. Verifique seu e-mail, caso não o tenha confirmado ao cadastrar-se.",
    'plan_insufficient_balance' => 'Saldo insulficiente para o plano escolhido.',
	/*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'attributes' => array(
        ...
        'email' => 'e-mail',
        'password' => 'senha',
        'allowed_requests' => 'consultas restantes',
        'excess_value' => 'valor da consulta adicional',
        'balance' => 'saldo',
        'number' => 'número',
        'value' => 'valor',
        'price' => 'mensalidade',
